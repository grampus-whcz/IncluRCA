#！/bin/bash
# nohup bash experiments_a.sh >> experiments_a_normal.log 2>&1 &

# echo "IncluRCA a_rca_trainer feature_integration_SEAttention new temp_data with normal"
# echo "--epochs 300 --pretrain_epochs 10 --pretrain_lr 0.001 --na_pos_weight 1.0 --fault_loss_weight 1.0 --na_loss_weight 0.15"
# python ./IncluRCA/trainer/a_rca_trainer_normal.py --window_size 11 --data_base_path /root/shared-nvme/work/code/RCA/IncluRCA \
...
# --pretrain_epochs 10 --pretrain_lr 0.001 --na_pos_weight 1.0 --fault_loss_weight 1.0 --na_loss_weight 0.15

# echo "IncluRCA a_localizer"
# echo "--epochs 300 --pretrain_epochs 10 --pretrain_lr 0.001 --na_pos_weight 1.0 --fault_loss_weight 1.0 --na_loss_weight 0.15"
# python ./IncluRCA/trainer/a_localizer_normal.py --window_size 11 --data_base_path /root/shared-nvme/work/code/RCA/IncluRCA \
# --dataset_path /root/shared-nvme/work/code/RCA/IncluRCA/temp_data/2022_CCF_AIOps_challenge/dataset/merge_multimodal/rca_multimodal_window_size_11.pkl \
# --model_path /root/shared-nvme/work/code/RCA/IncluRCA/model/a/checkpoint/main.pt \
...
# echo "IncluRCA a_rca_trainer feature_integration_SEAttention new temp_data with normal"
# echo "--pretrain_epochs 10 --pretrain_lr 0.001 --na_pos_weight 1.0 --fault_loss_weight 1.0 --na_loss_weight 0.1"
# python ./IncluRCA/trainer/a_rca_trainer_normal.py --window_size 11 --data_base_path /root/shared-nvme/work/code/RCA/IncluRCA \
# --dataset_path /root/shared-nvme/work/code/RCA/IncluRCA/temp_data/2022_CCF_AIOps_challenge/dataset/merge_multimodal/rca_multimodal_window_size_11.pkl \
# --model_path /root/shared-nvme/work/code/RCA/IncluRCA/model/a/checkpoint/main.pt \
# --epochs 300 --orl_te_heads 4 --orl_te_layers 2 --orl_te_in_channels 512 --efi_in_dim 512 --efi_te_heads 8 --efi_te_layers 2 --efi_out_dim 512 --eff_in_dim 512 --eff_GAT_out_channels 128 --eff_GAT_heads 4 --batch_size 64 --eff_GAT_dropout 0.1 \
# --GAT_name1 GATv2Conv --GAT_name2 GATConv --activ_fun1 relu6 --activ_fun2 relu6 --explainer_mask_acti_func relu \
# --pretrain_epochs 10 --pretrain_lr 0.001 --na_pos_weight 1.0 --fault_loss_weight 1.0 --na_loss_weight 0.1

# nohup bash experiments_a.sh >> experiments_a_new.log 2>&1 &

# echo "rca_multimodal_window_size_11_no_api.pkl"
# python ./IncluRCA/trainer/a_rca_trainer.py --window_size 11 --data_base_path /root/shared-nvme/work/code/RCA/IncluRCA \
# --dataset_path /root/shared-nvme/work/code/RCA/IncluRCA/temp_data/2022_CCF_AIOps_challenge/dataset/merge_multimodal/rca_multimodal_window_size_11_no_api.pkl \
# --model_path /root/shared-nvme/work/code/RCA/IncluRCA/model/a1/checkpoint/main.pt \
# --epochs 300 --orl_te_heads 4 --orl_te_layers 2 --orl_te_in_channels 512 --efi_in_dim 512 --efi_te_heads 8 --efi_te_layers 2 --efi_out_dim 512 --eff_in_dim 512 --eff_GAT_out_channels 128 --eff_GAT_heads 4 --batch_size 64 --eff_GAT_dropout 0.1 \
# --GAT_name1 GATv2Conv --GAT_name2 GATConv --activ_fun1 relu6 --activ_fun2 relu6 --explainer_mask_acti_func relu

# nohup bash experiments_a.sh >> experiments_a_ablation_RQ4.log 2>&1 &
# echo "IncluRCA a_rca_trainer feature_integration_SEAttention temp_data "
echo "reduction=4"
python ./IncluRCA/trainer/a_rca_trainer.py --window_size 11 --data_base_path /root/shared-nvme/work/code/RCA/IncluRCA \
--dataset_path /root/shared-nvme/work/code/RCA/IncluRCA/temp_data/2022_CCF_AIOps_challenge/dataset/merge_multimodal/rca_multimodal_window_size_11.pkl \
--model_path /root/shared-nvme/work/code/RCA/IncluRCA/model/a/checkpoint/main.pt \

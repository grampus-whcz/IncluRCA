...
class AblationFeatureIntegration(nn.Module):
...
class BaseAblation2Trainer(ABC):
    def __init__(self, param_dict):
        ...
        re_feature_integration = AblationFeatureIntegration(param_dict, self.rca_data_loader.meta_data)

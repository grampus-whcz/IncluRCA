...
from IncluRCA.ablation.base_ablation2_trainer import BaseAblation2Trainer
import argparse
from shared_util.file_handler import FileHandler
from shared_util.seed import *


class CRCATrainer(BaseAblation2Trainer):
...
if __name__ == '__main__':
    ...
    parser.add_argument("--model_path", default=f'{FileHandler.set_folder(model_base_path + "/checkpoint")}/ablation2.pt', type=str)

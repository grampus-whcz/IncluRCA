...
class BRCATrainer(BaseRCATrainer):
...
if __name__ == '__main__':
    ...
    model_save_base_path = FileHandler.set_folder(f'{data_base_path}/model/b')
    parser.add_argument("--model_path", default=f'{model_save_base_path}/main.pt', type=str)

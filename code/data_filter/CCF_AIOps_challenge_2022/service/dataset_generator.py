...
class DatasetGenerator(BaseGenerator):
    ...
    def generate_rca_multimodal_dataset(self):
        ...
        for window_size in self.window_size_list:
            ...
            # print("modal_data metric size: ", len(modal_dict['metric']['train_valid']))
            # print("modal_data trace size: ", len(modal_dict['trace']['train_valid']))
            # print("modal_data log size: ", len(modal_dict['log']['train_valid']))
            # print("modal_data api size: ", len(modal_dict['api']['train_valid']))

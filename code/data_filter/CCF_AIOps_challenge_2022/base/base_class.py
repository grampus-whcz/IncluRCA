...
class BaseClass(ABC):
    ...
    def rename_service2api(service_name):
        if service_name == "adservice":
            return ["hipstershop.AdService/GetAds", "hipstershop.adservice/getads"]
        elif service_name == "cartservice":
            return ["hipstershop.CartService/GetCart", "hipstershop.CartService/AddItem", "hipstershop.CartService/EmptyCart",
                    "/hipstershop.CartService/GetCart", "/hipstershop.CartService/AddItem", "/hipstershop.CartService/EmptyCart",
                    "HGET", "HMSET", "SET", "GET"]
            ...
            return ["hipstershop.CurrencyService/Convert", "hipstershop.CurrencyService/GetSupportedCurrencies",
                    "grpc.hipstershop.CurrencyService/Convert", "grpc.hipstershop.CurrencyService/GetSupportedCurrencies"]
        elif service_name == "emailservice":
            return ["hipstershop.EmailService/SendOrderConfirmation"]
        elif service_name == "paymentservice":
            return ["hipstershop.PaymentService/Charge", "grpc.hipstershop.PaymentService/Charge"]
        elif service_name == "productcatalogservice":
            return ["hipstershop.ProductCatalogService/ListProducts"]
        elif service_name == "recommendationservice":
            return ["hipstershop.RecommendationService/ListRecommendations"]

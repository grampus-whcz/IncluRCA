    ...
    def __init__(self):
        ...
        self.fault_type_related_o11y_names = {
            0: {
                ...
                "fuzzy": ["system.os.nofile.current", "system.os.nofile.used_pct"]
            },
            1: {
                "exact": ["system.load.1", "system.load.15", "system.load.5", "system.cpu.iowait", "system.cpu.pct_usage", "system.cpu.system", "system.cpu.user"],
                "fuzzy": ["system.os.nofile.current", "system.os.nofile.used_pct"]
            ...
            3: {
                ...
                "fuzzy": ["system.disk.free", "system.disk.pct_usage", "system.disk.used", "system.os.nofile.current", "system.os.nofile.used_pct"]
            },
            4: {
            ...
            6: {
                ...
                "fuzzy": ["kpi_container_cpu_cfs_periods"]
            },
            7: {
                ...
                "fuzzy": ["kpi_container_memory_failures", "kpi_container_memory_failcnt", "kpi_container_memory_max_usage_MB"]
            },
            8: {
                "exact": [],
                "fuzzy": ["<intensity>", "<duration>", "kpi_istio_tcp_received_bytes", "kpi_istio_tcp_sent_bytes", "kpi_container_sockets"]
            },
            9: {
                ...
                "fuzzy": ["kpi_istio_tcp_received_bytes", "kpi_istio_tcp_sent_bytes", "kpi_container_sockets"]
            },
            10: {
                "exact": [],
                "fuzzy": ["<intensity>", "<duration>", "http2.remote_reset", "kpi_istio_tcp_received_bytes", "kpi_istio_tcp_sent_bytes", "kpi_container_sockets"]
            },
            11: {
                "exact": ["kpi_container_network_receive_packets", "kpi_container_network_receive_MB", "kpi_container_network_transmit_packets", "kpi_container_network_transmit_MB"],
                "fuzzy": ["kpi_istio_tcp_received_bytes", "kpi_istio_tcp_sent_bytes", "kpi_container_sockets"]

...
from data_filter.Eadro_TT_and_SN.service.api_generator import ApiGenerator
...
class DatasetGenerator(BaseGenerator):
    ...
    def get_base_data(self, window_size, modal_type_list):
        ...
        if 'api' in modal_type_list:
            temp = ApiGenerator(self.base).get_api(window_size)
...
if __name__ == '__main__':
    dataset_generator = DatasetGenerator(BaseTTClass())

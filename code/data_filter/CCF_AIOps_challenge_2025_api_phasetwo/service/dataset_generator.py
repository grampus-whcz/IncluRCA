...
from data_filter.CCF_AIOps_challenge_2025_api.base.base_generator_phasetwo import BaseGenerator
from data_filter.CCF_AIOps_challenge_2025_api.service.time_interval_label_generator import TimeIntervalLabelGenerator
from data_filter.CCF_AIOps_challenge_2025_api.service.metric_generator import MetricGenerator
from data_filter.CCF_AIOps_challenge_2025_api.service.trace_generator import TraceGenerator
from data_filter.CCF_AIOps_challenge_2025_api.service.log_generator import LogGenerator
from data_filter.CCF_AIOps_challenge_2025_api.service.ent_edge_index_generator import EntEdgeIndexGenerator
from data_filter.CCF_AIOps_challenge_2025_api.util.dataset_handler import DatasetHandler
from data_filter.CCF_AIOps_challenge_2025_api.service.api_generator import ApiGenerator
...
class DatasetGenerator(BaseGenerator):
    def __init__(self):
        super().__init__()
        self.meta_data = {
            "modal_types": ['metric', 'trace', 'log', 'api'],
            "ent_types": ['node', 'service', 'tidb', 'pod'],
            ...
            'ent_fault_type_index': {
                "node": (0, 13),  # phaseone 14, phasetwo 13
                "service": (0, 13),
                "tidb": (0, 13),
                "pod": (0, 13),                
            },
            'ent_fault_type_weight': {
                "node": [138, 138, 138, 138, 138, 138, 138, 138, 138, 138, 138, 138, 138], # phaseone 14, phasetwo 13
                "service": [231, 231, 231, 231, 231, 231, 231, 231, 231, 231, 231, 231, 231],
                "tidb": [183, 183, 183, 183, 183, 183, 183, 183, 183, 183, 183, 183, 183],
                "pod": [183, 183, 183, 183, 183, 183, 183, 183, 183, 183, 183, 183, 183]                
            },
    ...
    def get_base_data(self, modal_type_list, window_size):
        ...
        if 'api' in modal_type_list:
            temp = ApiGenerator().get_api(window_size)
            self.meta_data['ent_features']['api'] = temp['entity_features']
            self.meta_data['o11y_names']['api'] = temp['api_names']
            self.meta_data['o11y_length']['api'] = len(temp['api_names'])
            modal_dict['api'] = temp['api_data']
    ...
    def generate_rca_multimodal_dataset(self):
        ...
        print(f'{self.config.param_dict["temp_data_storage"]}/dataset/merge_multimodal')
        for window_size in self.window_size_list:            
            print("window_size: ", window_size)
            
            modal_dict, ent_edge_index, y = self.get_base_data(modal_type_list, window_size)
            
            # print("ent_edge_index size: ", len(ent_edge_index['train_valid']))
            ...
            DatasetHandler.split_and_save_dataset(modal_type_list=modal_type_list,
                                                  ...
                                                  num_of_fault_types=13, # phaseone 14, phasetwo 13
